        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          {techCategories.map((category, categoryIndex) => (
            <motion.div
              ...
              className="hover:border-primary-500 rounded-2xl border-2 border-transparent bg-white p-6 shadow-lg transition-all hover:shadow-2xl dark:bg-gray-800"
            ...
            >
              ...
              <div className="mb-6">
                <h3
                  className={`bg-gradient-to-r text-xl font-bold ${category.color} mb-2 bg-clip-text text-transparent`}
                >
                  {category.category}
                </h3>
                  ...
                  >
                    <div className="mb-2 flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className="text-primary-500 dark:text-primary-400">{tech.icon}</div>
